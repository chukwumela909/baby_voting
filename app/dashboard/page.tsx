...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF5EB]">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="relative">
                <button className="flex items-center space-x-2 hover:opacity-80 transition-opacity">
                  ...
                  <span className="hidden sm:inline text-[#2D2D2D] font-medium">Sarah</span>
                </button>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-9 space-y-6 sm:space-y-8">
            ...
            <div className="bg-gradient-to-r from-[#FFB6C1] to-[#FFC0CB] rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-white relative overflow-hidden">
              ...
              <p className="text-white/90 text-sm sm:text-base mb-4 relative z-10">
                Your babies have received 45 new votes today
              </p>
              <button
                onClick={() => setIsModalOpen(true)}
          ...
          <div className="lg:col-span-3 space-y-6">
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-[#999999]">{baby.votes} votes</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* Leaderboard */}
            <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6">
              <h3 className="font-[family-name:var(--font-quicksand)] text-lg sm:text-xl font-bold text-[#2D2D2D] mb-4">
                Top This Week
              </h3>
              <div className="space-y-3">
                {[
                  ...
                  <div
                    ...
                    className="flex items-center space-x-3 p-2 rounded-xl hover:bg-[#FFF8F0] transition-colors cursor-pointer"
                  >
                    <span className="text-xl sm:text-2xl">{baby.badge}</span>
            ...
            <div className="bg-gradient-to-br from-[#FFE5D9] to-[#FFF5EB] rounded-2xl shadow-sm p-4 sm:p-6 relative overflow-hidden">
              ...
              <div className="space-y-3 relative z-10">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-[#FF9B50] text-lg">2</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#666666]">Total Votes</span>
                  <span className="font-bold text-[#FF9B50] text-lg">77</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#666666]">Votes Today</span>
                  <span className="font-bold text-[#FF9B50] text-lg">45</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Add Baby Modal */}
      <AddBabyModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </div>
  );
}
